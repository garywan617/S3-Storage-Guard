...
def lambda_handler(event, context):
    ...
    progress_bar(10)
    print("Created assignment2.txt with content: 'Empty Assignment 2222222222'")

    # Create object assignmen3.txt
    s3.put_object(Bucket=bucket_name, Key="assignment3.txt", Body="33")
    progress_bar(30)
    print("Created assignment3.txt with content: '33'")
    ...
    return {
        'statusCode': 200,
        'body': json.dumps('Finished Assignment4!')
    }
